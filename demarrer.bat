...
REM start /b E:\logiciels\mysql\bin\mysqld.exe
REM Démarrer une instance du serveur de test PHP pour déployer l'appli Web PHPMyAdmin
REM start /b E:\logiciels\php\php.exe -S 127.0.0.255:8080 -t E:\logiciels\phpmyadmin
